...
public class SegChinese {
    ...
    public SegChinese() {
            System.setProperty("mmseg.dic.path", "C:\\Users\\zoo88_000\\Documents\\NetBeansProjects\\TestXML\\src\\testxml\\data");	//這裡可以指定自訂詞庫
    ...
    protected ArrayList<SegmentStatus> getSegment(String[] args) throws IOException {
